...
readonly class AllItemsMatchCondition implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $kind = 'all_items_match',
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for AllItemsMatchCondition::fromArray()");
            }
        }
        return new self(
            ...
            kind: $data['kind'] ?? 'all_items_match',
        );
    }
