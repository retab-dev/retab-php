...
class WorkflowReviewVersionsTest extends TestCase
{
    use TestHelper;
    ...
    public function testList(): void
    {
        ...
        $this->assertStringEndsWith('v1/workflows/reviews/versions', $request->getUri()->getPath());
        parse_str($request->getUri()->getQuery(), $query);
        $this->assertSame('test_value', $query['review_id']);
    ...
    public function testCreate(): void
    {
        ...
        $this->assertSame('test_value', $body['review_id']);
        $this->assertSame('test_value', $body['parent_id']);
    }
    ...
    public function testGet(): void
    {
        ...
        $request = $this->getLastRequest();
        $this->assertSame('GET', $request->getMethod());
        $this->assertStringEndsWith('v1/workflows/reviews/versions/test_version_id', $request->getUri()->getPath());
    }
